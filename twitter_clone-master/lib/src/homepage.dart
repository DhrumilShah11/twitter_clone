...
import 'package:twitter_clone/lazy_load_REST.dart';

import '../lazy_load_practice.dart';
import 'tweets.dart';
            ...
            GestureDetector(
              ...
              onTap: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (_) => MyContactsPage()));
              },
              child: Container(
                width: 40,
                height: 40,
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    GestureDetector(
                      ...
                      onTap: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (_) => ContactsREST()));
                      },
                      child: Row(
                        crossAxisAlignment: CrossAxisAlignment.start,
